...
/**
 * @class Console
 * @brief Класс для работы с консолью ввода/вывода.
 *
 * Этот класс предоставляет консоль ввода-вывода.
 * Позволяет выводить сообщения, считывать ввод пользователя
 * и управлять выводом текстовой информации.
 */
